...
def build_model(input_shape=(4,), num_choices=2):
    model = tf.keras.Sequential([
        tf.keras.layers.Dense(256, activation="relu", kernel_regularizer=tf.keras.regularizers.l2(0.01), input_shape=input_shape),
